...
<body>
	...
	<spring:hasBindErrors name="pelicula">
		...
		<div class="alert alert-danger" role="alert">
			...
			<p>Favor corregir los siguientes errores:</p>
	...
	<div class="container theme-showcase" role="main">
		...
		<form:form action="${urlForm}" method="post" enctype="multipart/form-data" modelAttribute="pelicula" >
			 ...
			 <form:input class="form-control" path="id"/>
              <form:input class="form-control" path="detalle.id"/>
		
		<img class="img-rounded" src="${urlPublic}/img/${pelicula.imagen}"	 width="150" height="200">
				...
				<div class="col-sm-3">
					<div class="form-group">
						<label for="duracion">Duracion</label>
						 <form:input type="text" path="duracion"	class="form-control"  id="duracion" required="required" />
					</div>
				</div>
