				...
				<div class="col-sm-9">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<p>
								Título Original : ${pelicula.titulo} <br> Actores : James
								McAvoy, Anya Taylor Joy, Betty Buckley, Brad William Henke <br>
								Director: ${pelicula.detalle.director } <br> Clasificación:
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">
						<span class="label label-success">${fechaBuscada}</span>
					</h3>
				</div>
				<div class="panel-body">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<iframe width="100%" height="315"
								src="https://www.youtube.com/embed/HwDr7ff5GD4"> </iframe>
						</div>
					</div>
				</div>
				<div class="col-sm-5">
